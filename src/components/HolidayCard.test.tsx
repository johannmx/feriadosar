...
describe('HolidayCard', () => {
  it('renders correctly with given props', () => {
    ...
    expect(screen.getAllByText(/MAY\.?/i)[0]).toBeInTheDocument(); // short month in Spanish es-AR uppercase often includes a dot depending on environment, but based on my manual test it was 'MAY.' or 'MAY'
