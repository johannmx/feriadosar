...
describe('HolidayCard', () => {
  it('renders correctly with given props', () => {
    ...
    expect(screen.getByText(/^MAY\.?$/i)).toBeInTheDocument(); // short month in Spanish es-AR uppercase may or may not include a dot depending on ICU version / environment
